...
import iwo.wintech.ngnfincalc.repository.TaxBandRepository;
...
public class CalculationService {
    ...
    private BigDecimal calculateEstimatedTax(final CalculationParameters params, final BigDecimal totalInterest) {
        ...
        final TaxBandRepository.BrandTaxConfig brandConfig = taxBandRepository.findConfigByBrand(BrandContext.get());
