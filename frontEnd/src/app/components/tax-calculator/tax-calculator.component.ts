...
import { calculateDetailedPIT, calculateIncomeFromTax } from '../../app.utils';
import * as Const from '../../app.constants';
import { PITResult, IncomeFrequency } from '../../app.types';
...
export class TaxCalculatorComponent {
  ...
  protected onPeriodicInputChange(value: number): void {
    ...
    if (this.calculationMode() === 'incomeToTax') {
      ...
      const extrapolatedIncome = calculateIncomeFromTax(annualValue, Const.NIGERIA_PIT_BANDS_2026);
